        ...
        <div className="p-8 pb-32 max-w-[1200px] mx-auto w-full font-sans">
                        ...
                        <table className="w-full text-left border-collapse text-sm">
                            <thead>
                                <tr className="bg-slate-50 border-b border-slate-200">
                                    {["Name", "Email", "Status", "Actions"].map(
                                        (h) => (
                                            <th
                                                key={h}
                                                className={`px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-400 ${h === "Actions" ? "text-right" : ""}`}
                                            >
                                                {h}
                                            </th>
                                        ),
            ...
            >
                ...
                <p className="text-sm text-slate-500 mb-8">
                    Account will be scoped to your department automatically.
                </p>
