...
const StatCard = ({
    ...
    <Paper
        elevation={0}
        className="p-6 rounded-2xl border border-slate-200 flex items-center gap-5 bg-white hover:shadow-md transition-shadow"
    >
        ...
        <div className="p-8 pb-32 max-w-[1200px] mx-auto w-full font-sans">
            ...
            <div className="mb-8">
                <h1 className="text-2xl font-black text-slate-900 mb-1">
                    Welcome back, {name || "HOD"} 👋
                </h1>
                <p className="text-sm font-medium text-slate-500">
                    Here is an overview of your department operations.
                </p>
            </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs font-semibold text-amber-800 mt-1">
                                    {overdueSessions.length} overdue sessions
                                    and {dueSoonSessions.length} sessions due
                                    within {PROMOTION_ALERT_WINDOW_DAYS} days.
                                </p>
                            </div>
                        </div>
                    </Paper>
            ...
            >
                <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/60">
                    <h2 className="text-base font-black text-slate-900">
                        Academic Session Monitor
                    </h2>
                    <p className="text-xs font-medium text-slate-400 mt-0.5">
                        All academic batches in your department
                    </p>
                </div>
                ...
                {isLoading ? (
                    ...
                    <div className="p-16 text-center text-slate-400">
                        ...
                        <p className="font-bold">
                            No academic sessions in your department yet.
                        </p>
                        <p className="text-sm">
                            Contact the principal to approve a new intake.
                        </p>
                    </div>
                ) : (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <Chip
                                                label={s.status}
                                                size="small"
                                                className={`text-[10px]! font-black! uppercase! !tracking-widest border ${s.status === "active"
