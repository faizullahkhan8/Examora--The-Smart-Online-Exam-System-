...
const ExamPapers = () => {
    ...
    const papers = (data?.data ?? []).filter(
        (p) =>
            !preSelected ||
            (typeof p.subject === "object" ? p.subject._id : p.subject) ===
            preSelected,
    );
    ...
    return (
        <div className="p-8 pb-32 max-w-[1200px] mx-auto w-full font-sans">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-sm font-medium text-slate-500">
                        Create, manage, and submit exam papers for HOD review
                    </p>
                </div>
                <Button
                    component={Link}
                    to="/teacher/exam-papers/builder"
                    variant="contained"
            ...
            {isLoading ? (
                ...
                >
                    ...
                    <p className="text-sm text-slate-400 mt-1">
                        Use the <strong>New Paper</strong> button to open the
                        Paper Builder.
                    </p>
                    <Button
                        component={Link}
                        to="/teacher/exam-papers/builder"
                        variant="contained"
                        className="!mt-5 !bg-indigo-600 rounded-xl! font-bold! normal-case! shadow-none!"
                    >
                        Open Paper Builder
                    </Button>
                </Paper>
                ...
                <div className="space-y-4">
                    {papers.map((p: any) => {
                        const subj =
                            typeof p.subject === "object" ? p.subject : null;
                        return (
                            <Paper
                                key={p._id}
                                elevation={0}
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        ...
                                        {p.status === "draft" && (
                                            <>
                                                <Button
                                                    component={Link}
                                                    to={`/teacher/exam-papers/builder?edit=${p._id}`}
                                                    size="small"
                                                    variant="outlined"
                                                    startIcon={
                                                        <Edit2 size={12} />
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>
                        Once submitted, the HOD will review and approve or
                        reject this paper. You won't be able to edit it.
                    </DialogContentText>
                </DialogContent>
