...
import { Button, TextField, Skeleton, Alert } from "@mui/material";
import {
    Pencil,
    Save,
    X,
...
const InstituteProfile = () => {
    ...
    const [updateMyInstitute, { isLoading: saving }] =
        useUpdateMyInstituteMutation();
    ...
    const handleSave = async () => {
        if (isPlaceholder) {
            setSaveError(
                "No institute is linked to your account yet. Ask the Admin to assign one.",
            );
            return;
        }
        try {
            ...
            <div className="p-8 max-w-[1600px] mx-auto">
                ...
                <div className="space-y-6">
                    {isPlaceholder && (
                        ...
                        >
                            No institute is linked to your account yet. The data
                            shown below is placeholder. Ask the{" "}
                            <strong>Admin</strong> to assign your institute.
                        </Alert>
                    )}
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <div
                                className={`rounded-2xl p-8 relative overflow-hidden shadow-sm flex flex-col md:flex-row items-start md:items-center gap-6 ${isPlaceholder
                            ...
                            >
                                ...
                                <div
                                    className={`w-20 h-20 rounded-xl flex items-center justify-center text-3xl font-black shrink-0 relative z-10 ${isPlaceholder ? "bg-(--bg-base) border border-(--ui-border) text-(--text-secondary)" : "bg-white/10 text-white shadow-sm"}`}
                                >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div
                                        className={`flex items-center gap-2 mt-1.5 text-sm font-semibold ${isPlaceholder ? "text-(--text-secondary)" : "text-white/70"}`}
                                    >
                                        <Building2 size={16} />
                                        ...
                                        {isPlaceholder && (
                                            <span className="uppercase tracking-wider text-[10px] ml-2 border border-current px-1.5 py-0.5 rounded opacity-60">
                                                Placeholder
                                            </span>
                                        )}
                                    </div>
                            ...
                            <div className="bg-(--bg-surface) rounded-xl border border-(--ui-border) p-6 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <Field
                                        ...
                                        value={
                                            editing ? form.name : institute.name
                                        }
                                        editing={editing}
                                        name="name"
                                        onChange={onChange}
