    ...
    return (
        ...
        >
            ...
            <p className="text-xs text-(--text-secondary) font-medium mb-6">
                {editing
                    ? "Modify user details and credentials."
                ...
                <div className="mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-(--text-secondary) text-sm font-medium mt-1">
                            Provision Head of Department accounts and monitor
                            system access.
                        </p>
                    </div>
                            ...
                            <thead>
                                <tr className="border-b border-(--ui-divider) bg-(--bg-base) text-left">
                                    {[
                                        ...
                                        <th
                                            key={h}
                                            className={`px-6 py-3.5 text-xs font-bold uppercase tracking-wider text-(--text-secondary) ${i === 3 ? "text-right" : ""}`}
                                        >
                                            {h}
                                        </th>
                                    ))}
                        ...
                        {!isLoading && hods.length === 0 && (
                            <div className="text-center py-20 bg-(--bg-base)">
                                ...
                                <p className="text-sm font-medium text-(--text-secondary) mt-1">
                                    Click "Provision HOD" to onboard your first
                                    department head.
                                </p>
                            </div>
                        )}
