...
const menuItems = [
    { label: "Dashboard", icon: LayoutDashboard, url: "/teacher/dashboard" },
    { label: "My Subjects", icon: BookOpen, url: "/teacher/subjects" },
    { label: "Exam Papers", icon: FileText, url: "/teacher/exam-papers" },
