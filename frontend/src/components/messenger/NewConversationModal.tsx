...
const CONV_TYPES = [
    {
        id: "direct" as ConvType,
        label: "Direct",
        icon: Users,
        desc: "1-on-1 message",
    },
    {
        id: "group" as ConvType,
        label: "Group",
        icon: UserPlus,
        desc: "Multiple members",
    },
    {
...
const NewConversationModal: React.FC<Props> = ({
    ...
    const canProceed =
        step === 1
            ? selectedType !== null &&
            (selectedType === "direct" || groupName.trim().length > 0)
            ...
            >
                <div className="flex items-center gap-2">
                    {step === 2 && (
                        <button
                            onClick={() => setStep(1)}
                            className="mr-1 text-(--text-secondary) hover:text-(--text-primary) transition-colors outline-none"
                        >
                            <ChevronLeft size={20} />
                        </button>
                    )}
                    ...
                    <div className="space-y-6 py-2">
                                ...
                                {CONV_TYPES.map((type) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`text-[10px] font-medium ${selectedType === type.id ? "text-white/80" : "text-(--text-secondary)"}`}
                                            >
                                                {type.desc}
                                            </span>
                                        </button>
                            ...
                            selectedType === "announcement") && (
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        placeholder={
                                            selectedType === "group"
                                                ? "e.g. Faculty Discussion"
                                                : "e.g. Server Maintenance Alert"
                                        }
                                        value={groupName}
                                        onChange={(e) =>
                        ...
                        <div className="p-3.5 rounded-xl bg-amber-50 border border-amber-100 flex gap-3 items-start">
                            ...
                            <p className="text-[11px] font-semibold text-amber-800 leading-relaxed">
                                ...
                                System-wide broadcasts are strictly limited to
                                administrators.
                            </p>
                        </div>
                    </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="grow min-w-0">
                                                ...
                                                <p
                                                    className={`text-[10px] capitalize font-semibold truncate ${isSelected ? "text-white/80" : "text-(--text-secondary)"}`}
                                                >
                                                    {user.role} •{" "}
